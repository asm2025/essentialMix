...
namespace asm.Core.Data.Entity.Patterns.Provider
{
	public abstract class DataProvider<TType> : asm.Data.Patterns.Provider.DataProvider<TType>, IDataProvider<TType>
