...
namespace asm.Collections
{
	...
	//[DebuggerTypeProxy(typeof(asm_IndexMinDebugView<,,>))]
	[Serializable]
	...
	{
		internal sealed class DebugView : asm_IndexMinDebugView<KeyedBinaryNode<TKey, TValue>, TKey, TValue>
		{
	...
	{
		internal sealed class DebugView : asm_IndexMinDebugView<KeyedBinaryNode<T>, T, T>
		{
