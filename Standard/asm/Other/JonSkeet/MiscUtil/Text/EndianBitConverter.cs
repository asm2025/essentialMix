...
namespace Other.JonSkeet.MiscUtil.Text
{
	...
	public abstract class EndianBitConverter
	{
		...
		public char ToChar([NotNull] byte[] value, int startIndex) { return unchecked((char)CheckedFromBytes(value, startIndex, Constants.CHAR_SIZE)); }
		...
		public short ToInt16([NotNull] byte[] value, int startIndex) { return unchecked((short)CheckedFromBytes(value, startIndex, Constants.SHORT_SIZE)); }
		...
		public ushort ToUInt16([NotNull] byte[] value, int startIndex) { return unchecked((ushort)CheckedFromBytes(value, startIndex, Constants.USHORT_SIZE)); }
		...
		public int ToInt32([NotNull] byte[] value, int startIndex) { return unchecked((int)CheckedFromBytes(value, startIndex, Constants.INT_SIZE)); }
		...
		public uint ToUInt32([NotNull] byte[] value, int startIndex) { return unchecked((uint)CheckedFromBytes(value, startIndex, Constants.UINT_SIZE)); }
		...
		public long ToInt64([NotNull] byte[] value, int startIndex) { return CheckedFromBytes(value, startIndex, Constants.LONG_SIZE); }
		...
		public ulong ToUInt64([NotNull] byte[] value, int startIndex) { return unchecked((ulong)CheckedFromBytes(value, startIndex, Constants.ULONG_SIZE)); }
		...
		public float ToSingle([NotNull] byte[] value, int startIndex) { return Int32ToSingle(ToInt32(value, startIndex)); }
		...
		public double ToDouble([NotNull] byte[] value, int startIndex) { return Int64ToDouble(ToInt64(value, startIndex)); }
