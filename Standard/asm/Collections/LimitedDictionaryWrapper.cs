...
namespace asm.Collections
{
		...
		where TSource : IDictionary
	{
		...
		[NotNull] public static implicit operator TSource([NotNull] LimitedDictionaryWrapper<TSource> wrapper) { return wrapper.Source; }
	}
		...
		where TSource : IDictionary<TKey, TValue>
	{
		...
		[NotNull] public static implicit operator TSource([NotNull] LimitedDictionaryWrapper<TSource, TKey, TValue> wrapper) { return wrapper.Source; }
	}
}