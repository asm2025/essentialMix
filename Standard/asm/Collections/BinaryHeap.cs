...
namespace asm.Collections
{
	...
	[DebuggerTypeProxy(typeof(asm_BinaryHeapDebugView<,,>))]
	[Serializable]
	...
	{
		internal sealed class DebugView : asm_BinaryHeapDebugView<KeyedBinaryNode<TKey, TValue>, TKey, TValue>
		{
	...
	{
		internal sealed class DebugView : asm_BinaryHeapDebugView<KeyedBinaryNode<T>, T, T>
		{
