...
namespace asm.Collections
{
	...
	public class MinFibonacciHeap<TKey, TValue> : FibonacciHeap<TKey, TValue>
	{
		...
		/// <inheritdoc />
		protected internal MinFibonacciHeap([NotNull] Func<TValue, TKey> getKeyForItem, [NotNull] FibonacciNode<TKey, TValue> head)
			: this(getKeyForItem, head, null)
		{
		}

		/// <inheritdoc />
		protected internal MinFibonacciHeap([NotNull] Func<TValue, TKey> getKeyForItem, [NotNull] FibonacciNode<TKey, TValue> head, IComparer<TKey> comparer)
	...
	public class MinFibonacciHeap<T> : FibonacciHeap<T>
	{
		...
		/// <inheritdoc />
		protected internal MinFibonacciHeap([NotNull] FibonacciNode<T> head)
			: this(head, null)
		{
		}

		/// <inheritdoc />
		protected internal MinFibonacciHeap([NotNull] FibonacciNode<T> head, IComparer<T> comparer)
			: base(head, comparer)
		{
		}
