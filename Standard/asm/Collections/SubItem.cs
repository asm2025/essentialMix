...
{
	[Serializable]
	public class SubItem : Property, IFixable, IComparable<SubItem>, IComparable, IEquatable<SubItem>, INotifyPropertyChanged, ICloneable, ISerializable
	{
		...
		public SubItem(string name, object value)
			: this(name, null, value, false, false)
		{
		}

		public SubItem(string name, object value, bool isFixed)
			: this(name, null, value, isFixed, false)
		{
		}

		public SubItem(string name, object value, bool isFixed, bool isReadOnly)
		...
		public SubItem([NotNull] SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
