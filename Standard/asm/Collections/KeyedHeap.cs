...
namespace asm.Collections
{
		...
		where TNode : class, IKeyedNode<TKey, TValue>
	{
		...
		[NotNull]
		public abstract IEnumerableEnumerator<TValue> Enumerate(BreadthDepthTraverse method);

		#region Enumerate overloads
		[NotNull]
		public IEnumerableEnumerator<TValue> Enumerate() { return Enumerate(BreadthDepthTraverse.BreadthFirst); }
		#endregion
		...
		public abstract void Iterate(BreadthDepthTraverse method, [NotNull] Action<TNode> visitCallback);

		#region Iterate overloads - visitCallback action
		public void Iterate([NotNull] Action<TNode> visitCallback)
		{
			Iterate(BreadthDepthTraverse.BreadthFirst, visitCallback);
		}
		#endregion
		...
		public abstract void Iterate(BreadthDepthTraverse method, [NotNull] Func<TNode, bool> visitCallback);
