...
{
	public sealed class WaitAndPulseQueue : ProducerConsumerThreadQueue, IDisposable
	{
		...
		public WaitAndPulseQueue(CancellationToken token = default(CancellationToken))
			: this(null, token)
		{
		}

		public WaitAndPulseQueue(ProducerConsumerQueueOptions options, CancellationToken token = default(CancellationToken))
			: base(options, token)
		{
