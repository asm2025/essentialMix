...
namespace asm.Microsoft.Collections
{
	...
	[Serializable]
	[ComVisible(false)]
	public abstract class Dictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue>, ISerializable, IDeserializationCallback
	{
		[Serializable]
		public struct Enumerator : IEnumerator<KeyValuePair<TKey, TValue>>, IDictionaryEnumerator
		{
			...
			internal Enumerator([NotNull] Dictionary<TKey, TValue> dictionary, int getEnumeratorRetType)
			{
		...
		public sealed class KeyCollection : ICollection<TKey>, ICollection, IReadOnlyCollection<TKey>
		{
			...
			public struct Enumerator : IEnumerator<TKey>, IEnumerator
			{
				...
				internal Enumerator([NotNull] Dictionary<TKey, TValue> dictionary)
				{
					_dictionary = dictionary;
					_version = dictionary._version;
					_index = 0;
			...
			public KeyCollection([NotNull] Dictionary<TKey, TValue> dictionary) { _dictionary = dictionary; }
		...
		public sealed class ValueCollection : ICollection<TValue>, ICollection, IReadOnlyCollection<TValue>
		{
			...
			public ValueCollection([NotNull] Dictionary<TKey, TValue> dictionary) { _dictionary = dictionary; }
		...
		protected Dictionary(int capacity)
			: this(capacity, null)
		{
		}
		...
		protected Dictionary(int capacity, IEqualityComparer<TKey> comparer)
		{
		...
		protected Dictionary([NotNull] IDictionary<TKey, TValue> dictionary)
			: this(dictionary, null)
		{
		}

		protected Dictionary([NotNull] IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer)
		...
		public bool Remove(TKey key)
		{
			...
			for (int i = _buckets[bucket]; i >= 0; last = i, i = _entries[i].Next)
			{
				...
				if (!OnRemoving(key, entry.Value)) continue;
				entry.HashCode = -1;
		...
		protected virtual bool OnInserting(TKey key, TValue item) { return true; }
		protected virtual void OnInserted(TKey key, TValue item) { }
		protected virtual bool OnUpdating(TKey key, TValue item) { return true; }
		protected virtual void OnUpdated(TKey key, TValue item) { }
		protected virtual bool OnRemoving(TKey key, TValue item) { return true; }
		...
		private void Insert([NotNull] TKey key, TValue value, bool add)
		{
			...
			for (int i = _buckets[targetBucket]; i >= 0; i = _entries[i].Next)
			{
				...
				if (!OnUpdating(key, value)) continue;
			...
			if (!OnInserting(key, value)) return;
