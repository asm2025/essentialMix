...
namespace asm
{
	public static class Win32
	{
		...
		public enum DesktopAccessRightsEnum : long
		{
			...
			DESKTOP_ALL =
				DESKTOP_JOURNALRECORD | DESKTOP_JOURNALPLAYBACK | DESKTOP_CREATEWINDOW | DESKTOP_ENUMERATE | DESKTOP_WRITEOBJECTS | DESKTOP_SWITCHDESKTOP |
				DESKTOP_CREATEMENU | DESKTOP_HOOKCONTROL | DESKTOP_READOBJECTS
		}
		...
		{
			[FieldOffset(0)] public InputRecordEventTypeEnum EventType;
		...
		public class SHELLEXECUTEINFO
		{
			...
			[MarshalAs(UnmanagedType.LPTStr)] public string lpVerb = null;
			[MarshalAs(UnmanagedType.LPTStr)] public string lpFile = null;
			[MarshalAs(UnmanagedType.LPTStr)] public string lpParameters = null;
			[MarshalAs(UnmanagedType.LPTStr)] public string lpDirectory = null;
			public int nShow = (int)ShowWindowEnum.SW_SHOW;
			public IntPtr hInstApp = IntPtr.Zero;
			public IntPtr lpIDList = IntPtr.Zero;
			[MarshalAs(UnmanagedType.LPTStr)] public string lpClass = null;
		...
		public static extern IntPtr PathAddBackslash([MarshalAs(UnmanagedType.LPTStr)] StringBuilder lpszPath);
		...
		[DllImport("kernel32.dll", SetLastError = true)]
		public static extern int FormatMessage(FormatMessageFlags dwFlags, IntPtr lpSource, uint dwMessageId, uint dwLanguageId, ref IntPtr lpBuffer, uint nSize, IntPtr pArguments);
