...
{
	[DebuggerTypeProxy(typeof(Dbg_HeapBaseDebugView<,>))]
	[DebuggerDisplay("Count = {Count}")]
	[Serializable]
	public abstract class Heap<TNode, T> : IHeap<TNode, T>, ICollection<T>, IReadOnlyCollection<T>, ICollection
		where TNode : class, ITreeNode<T>
	{
		...
		/// <inheritdoc />
		T IHeap<T>.ExtractValue() { return ExtractValue().Value; }
