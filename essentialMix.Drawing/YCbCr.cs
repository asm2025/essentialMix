...
public class YCbCr
{
	...
	public static void FromRGB([NotNull] Rgb rgb, [NotNull] YCbCr ycbcr)
	{
	...
	[NotNull]
	public static YCbCr FromRGB([NotNull] Rgb rgb)
	{
	...
	public static void ToRGB([NotNull] YCbCr ycbcr, [NotNull] Rgb rgb)
	{
