...
public class QuickCipherService : IQuickCipherService
{
	public QuickCipherService()
	{
	}

	public string Hash(string text, Encoding encoding = null)
	{
	...
	public string Base64Encode(string text, Settings.Settings settings = null)
	{
		/*
	...
	public string Base64Decode(string base64Text, Encoding encoding = null)
	{
	...
	public string NumericEncode(string text, NumericSettings settings = null)
	{
		if (string.IsNullOrEmpty(text)) return text;
	...
	public string NumericDecode(string numericText, NumericSettings settings = null)
	{
	...
	public string AsymmetricEncrypt(string publicKeyXml, SecureString value, RSASettings settings = null)
	{
	...
	public string AsymmetricEncrypt(string publicKeyXml, string value, RSASettings settings = null)
	{
	...
	public byte[] AsymmetricEncrypt(string publicKeyXml, byte[] data, RSASettings settings = null)
	{
		if (publicKeyXml.Length == 0) throw new ArgumentNullException(nameof(publicKeyXml));
	...
	public string AsymmetricEncrypt(X509Certificate2 certificate, SecureString value, RSASettings settings = null)
	{
		return value.IsNullOrEmpty()
					? null
	...
	public string AsymmetricEncrypt(X509Certificate2 certificate, string value, RSASettings settings = null)
	{
		if (string.IsNullOrEmpty(value)) return value;
	...
	public byte[] AsymmetricEncrypt(X509Certificate2 certificate, byte[] data, RSASettings settings = null)
	{
		if (data.Length == 0) return null;
		IAsymmetricAlgorithm asymmetric = null;
	...
	private static byte[] AsymmetricEncrypt([NotNull] IAsymmetricAlgorithm asymmetric, [NotNull] byte[] data, RSASettings settings = null)
	{
		...
		if (settings is not { UseExpiration: true }) return asymmetric.Encrypt(data);
	...
	public SecureString AsymmetricDecrypt(string privateKeyXml, string value, RSASettings settings = null)
	{
	...
	public byte[] AsymmetricDecrypt(string privateKeyXml, byte[] data, RSASettings settings = null)
	{
		if (privateKeyXml.Length == 0) throw new ArgumentNullException(nameof(privateKeyXml));
		if (data.Length == 0) return null;
		...
		try
		{
			...
			if (!settings.UseExpiration) return decrypted;
	...
	public SecureString AsymmetricDecrypt(X509Certificate2 certificate, string value, RSASettings settings = null)
	{
		if (string.IsNullOrEmpty(value)) return null;
		byte[] encrypted = Convert.FromBase64String(value);
	...
	public byte[] AsymmetricDecrypt(X509Certificate2 certificate, byte[] data, RSASettings settings = null)
	{
		if (data.Length == 0) return null;
		IAsymmetricAlgorithm asymmetric = null;
	...
	private static byte[] AsymmetricDecrypt([NotNull] IAsymmetricAlgorithm asymmetric, [NotNull] byte[] data, RSASettings settings = null)
	{
		...
		if (settings is not { UseExpiration: true }) return decrypted;
		long ticks = BitConverter.ToInt64(decrypted, 0);
		DateTime expiration = new DateTime(ticks);
		if (DateTime.UtcNow > expiration) return null;
		decrypted = decrypted.GetRange(sizeof(long), -1);
	...
	public string SymmetricEncrypt(string base64Key, SecureString value, SymmetricSettings settings = null)
	{
		return value.IsNullOrEmpty()
					? null
	...
	public string SymmetricEncrypt(string base64Key, string value, SymmetricSettings settings = null)
	{
	...
	public byte[] SymmetricEncrypt(byte[] key, byte[] data, SymmetricSettings settings = null)
	{
		...
		try
		{
			...
			if (!settings.UseExpiration) return symmetric.Encrypt(data);
			byte[] expiration = BitConverter.GetBytes(settings.GetExpiration().Ticks);
			byte[] buffer = new byte[expiration.Length + data.Length];
			expiration.CopyTo(buffer, 0);
			data.CopyTo(buffer, expiration.Length);
	...
	public SecureString SymmetricDecrypt(string base64Key, string value, SymmetricSettings settings = null)
	{
		if (base64Key.Length == 0) throw new ArgumentNullException(nameof(base64Key));
		if (string.IsNullOrEmpty(value)) return null;
	...
	public byte[] SymmetricDecrypt(byte[] key, byte[] data, SymmetricSettings settings = null)
	{
		if (key.Length == 0) throw new ArgumentNullException(nameof(key));
		if (data.Length == 0) return null;
		int keySize = BitHelper.GetBitSize(key.Length);
	...
	public string HyperEncrypt(string publicKeyXml, SecureString value, HyperSettings settings = null)
	{
		return value.IsNullOrEmpty()
					? null
	...
	public string HyperEncrypt(string publicKeyXml, string value, HyperSettings settings = null)
	{
		if (publicKeyXml.Length == 0) throw new ArgumentNullException(nameof(publicKeyXml));
		if (string.IsNullOrEmpty(value)) return value;
	...
	public byte[] HyperEncrypt(string publicKeyXml, byte[] data, HyperSettings settings = null)
	{
		/*
		* finalBytes will contain the following:
		* +-----------+-----------+--------+
	...
	public SecureString HyperDecrypt(string privateKeyXml, string value, HyperSettings settings = null)
	{
		if (privateKeyXml.Length == 0) throw new ArgumentNullException(nameof(privateKeyXml));
		if (string.IsNullOrEmpty(value)) return null;
		settings ??= new HyperSettings();
	...
	public byte[] HyperDecrypt(string privateKeyXml, byte[] data, HyperSettings settings = null)
	{
	...
	public string RandomString(int length, NumericSettings settings = null)
	{
	...
	public IRandomNumberGenerator CreateRandomNumberGenerator() { return new RNGCryptoServiceProvider(); }

	public INumericEncoder CreateNumericEncoder(NumericSettings settings = null)
	{
		settings ??= new NumericSettings();
		return new NumericEncoder(settings.Mode, settings.Encoding);
	}

	public IHashAlgorithm CreateHashAlgorithm(Encoding encoding = null) { return new SHA256CryptoServiceProvider(encoding ?? Encoding.Unicode); }

	public (string Public, string Private) GenerateAsymmetricKeys(RSASettings settings = null) { return GenerateAsymmetricKeys(true, settings); }
	public (string Public, string Private) GenerateAsymmetricKeys(bool includeBitStrength, RSASettings settings = null)
	{
	...
	public byte[] GenerateSymmetricKey(SymmetricSettings settings = null)
	{
		byte[] keyBytes;
		settings ??= new SymmetricSettings();
	...
	public IAsymmetricAlgorithm CreateAsymmetricAlgorithm(RSASettings settings = null)
	{
		settings ??= new RSASettings();
	...
	public ISymmetricAlgorithm CreateSymmetricAlgorithm(SymmetricSettings settings = null)
	{
		settings ??= new SymmetricSettings();
