...
public sealed class RabbitMQProducerService(
	[NotNull] IConnectionFactory factory,
	[NotNull] ProduceSettings settings,
	[NotNull] ILogger<RabbitMQProducerService> logger)
	: Producer(factory, settings, logger)
{
